...
const ShareAlt = () => {
  ...
  return (
    <>
      ...
      <div style={{ padding: '2vh 0', display:'none' }}>
        <p className="specialfont pleaseshare" style={{ margin: '2vh auto', textAlign: 'center', fontSize: '90%' }}>Please Share:</p>
        <div className="sharebutts" style={{ background: 'transparent', borderRadius: "var(--theme-ui-colors-borderRadius)", width: '400px', color: '', fill: '', padding: ' 0', display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', margin: '0 auto' }}>
          {/* Sharingbutton Facebook */}
          <a className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=${siteUrl + pathname}`} target="_blank" rel="noreferrer" aria-label="Facebook">
            <div className="resp-sharing-button resp-sharing-button--facebook resp-sharing-button--medium"><div aria-hidden="true" className="resp-sharing-button__icon resp-sharing-button__icon--solidcircle">
              <svg version="1.1" x="0px" y="0px" width="44px" height="44px" viewBox="0 0 24 24" xmlSpace="preserve"><path d="M12 0C5.38 0 0 5.38 0 12s5.38 12 12 12 12-5.38 12-12S18.62 0 12 0zm3.6 11.5h-2.1v7h-3v-7h-2v-2h2V8.34c0-1.1.35-2.82 2.65-2.82h2.35v2.3h-1.4c-.25 0-.6.13-.6.66V9.5h2.34l-.24 2z" /></svg></div></div>
          </a>
          {/* Sharingbutton Twitter */}
          <a className="resp-sharing-button__link" href={`https://twitter.com/intent/tweet/?text=Check%20out%20this%20cool%20site.&amp;url=${siteUrl + pathname}`} target="_blank" rel="noreferrer" aria-label="Twitter">
            <div className="resp-sharing-button resp-sharing-button--twitter resp-sharing-button--medium"><div aria-hidden="true" className="resp-sharing-button__icon resp-sharing-button__icon--solidcircle">
              <svg version="1.1" x="0px" y="0px" width="44px" height="44px" viewBox="0 0 24 24" enableBackground="new 0 0 24 24" xmlSpace="preserve"><path d="M12 0C5.38 0 0 5.38 0 12s5.38 12 12 12 12-5.38 12-12S18.62 0 12 0zm5.26 9.38v.34c0 3.48-2.64 7.5-7.48 7.5-1.48 0-2.87-.44-4.03-1.2 1.37.17 2.77-.2 3.9-1.08-1.16-.02-2.13-.78-2.46-1.83.38.1.8.07 1.17-.03-1.2-.24-2.1-1.3-2.1-2.58v-.05c.35.2.75.32 1.18.33-.7-.47-1.17-1.28-1.17-2.2 0-.47.13-.92.36-1.3C7.94 8.85 9.88 9.9 12.06 10c-.04-.2-.06-.4-.06-.6 0-1.46 1.18-2.63 2.63-2.63.76 0 1.44.3 1.92.82.6-.12 1.95-.27 1.95-.27-.35.53-.72 1.66-1.24 2.04z" /></svg></div></div>
          </a>
          {/* Sharingbutton E-Mail */}
          <a className="resp-sharing-button__link" href={`mailto:?subject=Check%20out%20this%20cool%20site.&amp;body=${siteUrl + pathname}`} target="_self" rel="noreferrer" aria-label="E-Mail">
          ...
          <a className="resp-sharing-button__link" href={`https://pinterest.com/pin/create/button/?url=${siteUrl + pathname}&amp;media=${siteUrl}&amp;description=Check%20out%20this%20cool%20site`} target="_blank" rel="noreferrer" aria-label="Pinterest">
          ...
          <a className="resp-sharing-button__link" href={`https://www.linkedin.com/shareArticle?mini=true&amp;url=${siteUrl + pathname}&amp;title=Check%20out%20this%20cool%20site.&amp;summary=Check%20out%20this%20cool%20site.&amp;source=${siteUrl}`} target="_blank" rel="noreferrer" aria-label="LinkedIn">
            <div className="resp-sharing-button resp-sharing-button--linkedin resp-sharing-button--medium">
              <div aria-hidden="true" className="resp-sharing-button__icon resp-sharing-button__icon--solidcircle">
                <svg version="1.1" x="0px" y="0px" width="44px" height="44px" viewBox="0 0 24 24" enableBackground="new 0 0 24 24" xmlSpace="preserve">
