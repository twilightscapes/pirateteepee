...
<div id="posttop" className={containerClass}
  ...
  {node.frontmatter.externalLink ? (
    ...
    <iframe loading="lazy" id="" style={{width:'100%', minWidth:'', maxHeight:'80vh', margin:'0 auto'}} title="iFrame" className="iframe boom" width="980" height="550" src={node.frontmatter.externalLink} frameBorder="0" allowFullScreen></iframe>
